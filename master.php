            ...
            <div class="row align-items-center">
                <div class="col-md-7">
                    <div class="topbar-info-text">
                        <p>We are always ready to protect your data <a href="contact.php">Contact now</a></p>
                    </div>
                </div>
			...
			<nav class="navbar navbar-expand-lg">
				<div class="container">
					...
					<a class="navbar-brand" href="./">
						<img src="images/xperteck-logo-new.jpeg" alt="Logo">
					</a>
					<!-- Logo End -->
					...
					<div class="collapse navbar-collapse main-menu">
                        ...
                        <div class="header-btn">
                            ...
                            <a href="contact.php" class="btn-default">Explore products</a>
                        </div>
                        <!-- Header Btn End -->
					</div>
					<!-- Main Menu End -->
