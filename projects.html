            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="wow fadeInUp" data-cursor="-opaque">Our projects</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="project-content">
                            <p><a href="project-single.html">protection</a></p>
                            <h3><a href="project-single.html">Proactive threat detection and response</a></h3>
                        </div>
                    </div>
                    <!-- Project Item End -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="project-content">
                            <p><a href="project-single.html">monitoring</a></p>
                            <h3><a href="project-single.html">Comprehensive risk assessment programs</a></h3>
                        </div>
                    </div>
                    <!-- Project Item End -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="project-content">
                            <p><a href="project-single.html">compliance</a></p>
                            <h3><a href="project-single.html">Cybersecurity awareness and training campaigns</a></h3>
                        </div>
                    </div>
                    <!-- Project Item End -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="project-content">
                            <p><a href="project-single.html">vulnerabilities</a></p>
                            <h3><a href="project-single.html">Real-time network monitoring systems</a></h3>
                        </div>
                    </div>
                    <!-- Project Item End -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="1s">
                        ...
                        <div class="project-content">
                            <p><a href="project-single.html">encryption</a></p>
                            <h3><a href="project-single.html">Vulnerability management lifecycle project</a></h3>
                        </div>
                    </div>
                    <!-- Project Item End -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="1.2s">
                        ...
                        <div class="project-content">
                            <p><a href="project-single.html">authentication</a></p>
                            <h3><a href="project-single.html">Behavioral analytics for cyber threats</a></h3>
                        </div>
                    </div>
                    <!-- Project Item End -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="1.4s">
                        ...
                        <div class="project-content">
                            <p><a href="project-single.html">vulnerabilities</a></p>
                            <h3><a href="project-single.html">Adaptive security architecture design</a></h3>
                        </div>
                    </div>
                    <!-- Project Item End -->
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- Project Item Start -->
                    <div class="project-item wow fadeInUp" data-wow-delay="1.6s">
                        <div class="project-image">
                            <a href="project-single.html" data-cursor-text="View">
                                <figure class="image-anime">
