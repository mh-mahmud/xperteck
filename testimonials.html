            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="wow fadeInUp" data-cursor="-opaque">Testimonials</h1>
                    ...
                    <div class="testimonial-item wow fadeInUp">
                        <div class="testimonial-header">
                            <div class="testimonial-company-logo">
                                <img src="images/company-logo-linear.svg" alt="">
                            </div>        
                            <div class="testimonial-quote">
                                <img src="images/testimonial-quote-linear.svg" alt="">
                            </div>
                        </div>                               
                        <div class="testimonial-content">
                            <p>"Exceptional service! proactive approach to threat detection and prevention gave us peace of mind and ensured our systems remain secure."</p>
                        </div>
